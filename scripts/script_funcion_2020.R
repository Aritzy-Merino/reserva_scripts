...
datos <- read_csv("210128-BD-Datos_funcion_policial_2020.csv")


#Observaciones sin NA
#datos_completo <- datos[complete.cases(datos),]
datos$Vocacional_2017 <- as.numeric(as.character(datos$Vocacional_2017))
datos$Linea_ingreso <- as.numeric(as.character(datos$Linea_ingreso))
datos$Control_confianza <- as.numeric(as.character(datos$Control_confianza))
